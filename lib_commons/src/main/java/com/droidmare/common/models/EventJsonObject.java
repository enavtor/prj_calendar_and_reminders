...
public class EventJsonObject extends JSONObject {
    ...
    public long getReminderMillis(boolean settingNewAlarm) {
        ...
        long currentRepetition = this.getLong(ConstantValues.CURRENT_REPETITION, -1);

        if (settingNewAlarm) currentRepetition = this.getLong(ConstantValues.NEXT_REPETITION, -1);
